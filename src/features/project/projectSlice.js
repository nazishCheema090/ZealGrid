...
export const saveProjectData = createAsyncThunk('project/saveProjectData', async(data, thunkAPI)=>{
    try {
        ...
        return formattedData; // Return the formatted data or any success indicator
    } catch (error) {
...
const projectSlice = createSlice({
        ...
        extraReducers : (builder) =>{
            builder.addCase(saveProjectData.pending, (state) => {
                state.loading = true;
                state.error = null;
            })
